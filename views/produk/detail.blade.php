			...
			<tr>
				...
				<td>
					<div class="image-wrapper-4 active">
						<div class="image">
							<a href="#">
								{{ HTML::image(product_image_url($produk->gambar1,'thumb'),'thumbnail 1',array('width'=>'60')) }}
							</a>
						</div>
					</div>
				</td>
				...
				<td>
					<div class="image-wrapper-4 active">
						<div class="image">
							<a href="#">
								{{ HTML::image(product_image_url($produk->gambar2,'thumb'),'thumbnail 2',array('width'=>'60')) }}
							</a>
						</div>
					</div>
				</td>
				...
				<td>
					<div class="image-wrapper-4 active">
						<div class="image">
							<a href="#">
								{{ HTML::image(product_image_url($produk->gambar3,'thumb'),'thumbnail 3',array('width'=>'60')) }}
							</a>
						</div>
					</div>
				</td>
				...
				<td>
					<div class="image-wrapper-4 active">
						<div class="image">
							<a href="#">
								{{ HTML::image(product_image_url($produk->gambar4,'thumb'),'thumbnail 4',array('width'=>'60')) }}
							</a>
						</div>
					</div>
				</td>
